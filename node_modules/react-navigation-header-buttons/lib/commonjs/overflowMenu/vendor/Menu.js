...
class Menu extends React.Component {
  ...
  anchor = null;
  menu = null;
  isAnchorCoord = () => ! /*#__PURE__*/React.isValidElement(this.props.anchor);
  ...
  attachListeners = () => {
    this.backPressListener = _reactNative.BackHandler.addEventListener('hardwareBackPress', this.handleDismiss);
    this.dimensionChangeListener = _reactNative.Dimensions.addEventListener('change', this.handleDismiss);
    this.isBrowser() && document.addEventListener('keyup', this.handleKeypress);
  };
  removeListeners = () => {
    var _this$backPressListen, _this$dimensionChange;
    this === null || this === void 0 ? void 0 : (_this$backPressListen = this.backPressListener) === null || _this$backPressListen === void 0 ? void 0 : _this$backPressListen.remove();
    this === null || this === void 0 ? void 0 : (_this$dimensionChange = this.dimensionChangeListener) === null || _this$dimensionChange === void 0 ? void 0 : _this$dimensionChange.remove();
  ...
  render() {
    ...
    return rendered ? /*#__PURE__*/React.createElement(_reactNative.View, {
